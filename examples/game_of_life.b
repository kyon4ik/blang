...
print() {
    extrn printf, width, height, get, board;
    auto x, y;
...
step() {
    extrn printf, count_neighbours, get, width, height, board, set, next;
...
main() {
    ...
    extrn width, height, board1, board2, board, next, set, print, step;
    auto size;
    width  = 25;
    height = 15;
